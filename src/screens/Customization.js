...
const optionsTypeService = ["Manicure", "Pedicure"];
const optionsNailPolish = [
  "Gel Polish (China Brand)",
  "Gel Polish (Orly Brand)",
  "Gel Polish (Coucou Brand)",
];
...
const Customization = () => {
  ...
  const handleSave = () => {
    ...
    formdata.append("service_type", displayTypeService);
    formdata.append("nail_polish_brand", displayNailPolish);
