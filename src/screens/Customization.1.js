...
import { Text, Layout, Select, SelectItem } from "@ui-kitten/components";
...
export const Customization = () => {
  ...
  const displayExtensions = optionsExtensions[selectedExtensions.row];
  ...
  const handleSave = () => {
    ...
    // console.log(displayTypeService);
    // console.log(displayNailPolish);
    // console.log(displayNailSize);
    // console.log(displayExtensions);
    // const formdata = new FormData();
    // formdata.append("user_id", user.user.id);
    // formdata.append("service_type", selectedTypeService);
    // formdata.append("nail_polish_brand", selectedNailPolish);
    // formdata.append("nail_size", selectedNailSize);
    // formdata.append("has_extensions", selectedExtensions);
    // api
    //   .post("storeCustomization", formdata)
    //   .then((response) => {
    //     console.log(response);
    //     Alert.alert("Success!", "Customization Successfully Saved");
    //   })
    //   .catch((err) => {
          ...
          {displayTypeService == "Manicure" ? (
            ...
            >
              ...
              <G id="SVGRepo_iconCarrier">
                ...
                <Path
                  style={{ fill: `${nailColor}` }}
                  d="M225.039,221.465c0,0,1.703,21.194,17.23,24.763C242.269,246.228,248.711,241.812,225.039,221.465z"
                ></Path>
                <Path
                  style={{ fill: "#E8C7AF" }}
            ...
            >
              ...
              <G id="SVGRepo_iconCarrier">
                ...
                <G>
                  ...
                  ></Ellipse>
                  <Ellipse
                    transform="matrix(-0.7721 -0.6355 0.6355 -0.7721 281.5777 731.2943)"
                    style={{ fill: "#D10566" }}
                    cx="271.915"
                    cy="315.158"
                    rx="33.889"
              ...
              colors.map((item, index) => {
                return (
                  <TouchableOpacity
                    ...
                    onPress={() => setNailColor(item.color)}
                  />
                );
              })}
          </View>
          ...
          >
            <Layout>
              <Select
                ...
                value={displayTypeService}
                selectedIndex={selectedTypeService}
                onSelect={(index) => setSelectedTypeService(index)}
              >
                <SelectItem title="Manicure" />
                <SelectItem title="Pedicure" />
              </Select>
              <Select
                style={{
                  width: 380,
                ...
                value={displayNailPolish}
                selectedIndex={selectedNailPolish}
                onSelect={(index) => {
                  setSelectedNailPolish(index);
                }}
              >
                <SelectItem title="Gel Polish (China Brand)" />
                <SelectItem title="Gel Polish (Orly Brand)" />
                <SelectItem title="Gel Polish (Coucou Brand)" />
              </Select>
              <Select
                style={{
                  width: 380,
                ...
                label="Nail Size"
                value={displayNailSize}
                selectedIndex={selectedNailSize}
                onSelect={(index) => {
                  setSelectedNailSize(index);
                }}
              >
                <SelectItem title="Small" />
                <SelectItem title="Big" />
              </Select>
              <Select
                style={{
                  width: 380,
                ...
                value={displayExtensions}
                selectedIndex={selectedExtensions}
                onSelect={(index) => {
                  setSelectedExtensions(index);
                }}
              >
